...
import { TwitterIcon, CodeforcesIcon, GithubIcon, LinkedInIcon, MoonIcon, SunIcon } from './Icons';
...
const NavBar = () => {
    ...
    return (
        <header
            className='z-10 lg:px-16 md:px-12 sm:px-8 w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light relative'
        >
            ...
            <div className=' w-full flex justify-between items-center lg:hidden'>
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://x.com/debangi29" target={"_blank"}
                        whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}
                        className="w-6 mr-3"
                    ><TwitterIcon /></motion.a>
                    <motion.a href="https://github.com/debangi29" target={"_blank"} className="w-6 mx-3" whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}><GithubIcon /></motion.a>
                    <motion.a href="https://www.linkedin.com/in/debangi-ghosh-b139471ba/" target={"_blank"} className="w-6 mx-3" whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}><LinkedInIcon /></motion.a>
                    {/* <motion.a href="/" target={"_blank"} className="w-6 mx-3" whileHover={{ y: -2 }}
                    whileTap={{ scale: 0.9 }}><PinterestIcon /></motion.a> */}
                    <motion.a href="https://codeforces.com/profile/debangi_29" target={"_blank"} className="w-6 ml-3" whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}><CodeforcesIcon /></motion.a>
            ...
            {isOpen && (<motion.div initial={{ scale: 0, opacity: 0 }} animate={{ scale: 1, opacity: 1, x: '-50%', y: '-50%' }} className=' min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/75 rounded-lg backdrop-blur-md py-32'>
                ...
                <nav className="flex items-center justify-center flex-wrap">
                    <motion.a href="https://x.com/debangi29" target={"_blank"}
                        ...
                        className="w-6 mr-3"
                    ><TwitterIcon /></motion.a>
                    <motion.a href="https://github.com/debangi29" target={"_blank"} className='w-6 mx-3 sm:mx-1 bg-light rounded-full' whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}><GithubIcon /></motion.a>
                    <motion.a href="https://www.linkedin.com/in/debangi-ghosh-b139471ba/" target={"_blank"} className="w-6 mx-3" whileHover={{ y: -2 }}
                        whileTap={{ scale: 0.9 }}><LinkedInIcon /></motion.a>
                    {/* <motion.a href="/" target={"_blank"} className="w-6 mx-3" whileHover={{ y: -2 }}
