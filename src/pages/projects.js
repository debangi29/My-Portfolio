...
const projects = () => {
    return (
        <>
            <Head>
                <title>Debangi | Projects Page</title>
                <meta name='description' content='any description'></meta>
            </Head>
            <Transition></Transition>
            <main className=' w-full mb-16 flex flex-col items-center justify-center dark:bg-dark dark:text-light'>
                <Layout className=' pt-16'>
                    <AnimatedText className=' mb-16 lg:text-7xl sm:mb-8 sm:!text-6xl xs:!text-4xl' text='Building Learning Innovating! '></AnimatedText>
                    <div className=' grid-cols-12 gap-24 grid gap-y-32 xl:gap-x-16 lg:gap-x-8 md:gap-y-24 sm:gap-x-0'>
                        <div className=' col-span-12'>
                            <FeaturedProject github='https://github.com/Shashankss1205/TabuleX' img={project2} link='https://github.com/Shashankss1205/TabuleX' type='Featured Project' title='Tabular Data Analysis Tool' summary='Developed a flask based ChatBot and Graph Plotter using Vanilla JavaScript,a database backend using
                            SQLite and integrated a prompting NLP tool, Gemini API. It is a multilingual, responsive tool for tabular data analysis with a friendly UI/UX, capable of efficiently analyzing handwritten or printed table images, supporting multiple table schemas, and performing CRUD operations.' />
                        </div>
                        <div className=' col-span-6 sm:col-span-12'>
                            <Project github='https://github.com/debangi29/DesignDiva_Myntra' img={project1} link='https://github.com/debangi29/DesignDiva_Myntra' type='Project' title='Customisation Integration on Myntra' />
                        </div>
                        <div className=' col-span-6 sm:col-span-12'>
                            <Project github='https://github.com/Shashankss1205/TeamTitans' img={project3} link='https://github.com/Shashankss1205/TeamTitans' type='Project' title='Dark Patterns Detector Extension' />
                        </div>
                        {/* <div className=' col-span-12'>
                        ...
                        <div className=' col-span-6 sm:col-span-12'>
                            <Project github='https://github.com/debangi29/Modified-focal-Loss-function_ML' img={project5} link='https://github.com/debangi29/Modified-focal-Loss-function_ML' type='Project' title='Focal Loss Refinement for Improved Machine Learning Accuracy' />
                        </div>
                        <div className=' col-span-6 sm:col-span-12'>
                            <Project github='https://github.com/debangi29/Exploratory-Project-based-on-CNN' img={project4} link='https://github.com/debangi29/Exploratory-Project-based-on-CNN' type='Exploratory Project' title='CNN based classification of brain tumors using MRI dataset' />
                        </div>
